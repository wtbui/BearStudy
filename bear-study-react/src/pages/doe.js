...
import audio2 from "../assets/Typing Keyboard.mp3";
import audio3 from "../assets/2 Minute White Noise.mp3"
...
export default function Doe() {
    ...
    return (
        ...
        style={{
            backgroundImage: `url(${require('../assets/doe_background.png')})`,
            ...
            <div className="header">
                ...
                <div className= { getTabClassSpotify(showSpotify) }>
                    ...
                    <Spotify uri="spotify:playlist:7ro8ULOhjgxxL3tN0uf7KS" size="large" 
            ...
            <div className="tabs">
                ...
                <div className="ambience" flex-direction="column" >
                    ...
                    volume2={volume2} handleVolume2={handleVolume2} volume2Title="keyboard typing"
                    volume3={volume3} handleVolume3={handleVolume3} volume3Title="white noise"
