...
import audio1 from "../assets/wind rustling.mp3";
import audio2 from "../assets/talking.mp3";
import audio3 from "../assets/rain.mp3";
import audio4 from "../assets/rustling-grass.mp3";
        ...
        style={{
            ...
            <div className="tabs">
                ...
                <div className="ambience" flex-direction="column" >
                    ...
                    {showAmbience && <Ambience volume={volume} handleVolume={handleVolume} volumeTitle="wind breeze"
                    audio1Ref={audio1Ref} handlePlay={handlePlay} 
                    volume2={volume2} handleVolume2={handleVolume2} volume2Title="people chatter"
                    volume3={volume3} handleVolume3={handleVolume3} volume3Title="rainy day"
                    volume4={volume4} handleVolume4={handleVolume4} volume4Title="grass rustling"
